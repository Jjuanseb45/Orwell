...
let dataQuestions = [
    ...
    new question(1, "A New Home", "Who is the main character?", 'Francisco'),
    new question(2, "A New Home", "Francisco just bought a new _____", 'House'),
    new question(3, "A New Home", "What is peeling off the walls?", 'The paint'),
    new question(4, "A New Home", "There is a lot of furniture in the house <br> (True or False)", 'False'),
    new question(5, "A New Home", "The house is dirty and smells bad <br> (True or False)", 'True'),
    new question(6, "A New Home", "The window is broken <br> (True or False)", 'True'),
    new question(7, "A New Home", "The bathrrom is in bad _________", 'condition'),
    new question(8, "A New Home", "The house doesn't have a kitchen but there is a <br> _________ on the floor ", 'Microwave'),
    new question(9, "A New Home", "What part of his body does Francisco cover when he opens the bathroom door?", 'His nose'),
    new question(1, "At The Airport", "Who is the main character?", 'Miguel'),
    new question(2, "At The Airport", "What is the number of the flight?", '103'),
    new question(3, "At The Airport", "What is the flight destination?", 'Hawaii'),
    new question(4, "At The Airport", "Miguel has one small carry on bag <br> (True or False)", 'True'),
    new question(5, "At The Airport", "The dog is trying to detect drugs or __________", 'explosives'),
    new question(6, "At The Airport", "What animal accompanies the officers?", 'A dog'),
    new question(7, "At The Airport", "How old is Miguel? (Write just the number)", '40'),
    new question(8, "At The Airport", "Who asks Miguel for his ID?", 'The lady at the counter'),
    new question(9, "At The Airport", "After the dog smelled the luggage, it started to", 'bark')
];