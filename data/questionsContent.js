...
let dataQuestions = [
    ...
    new question(1, "The Menu", " I wake up at _ AM", '6'),
    new question(2, "The Menu", "After I get dressed I _____ __ ______", 'Brush my teeths'),
    new question(3, "The Menu", "What do i hate?", 'Take a shower'),
    new question(4, "The Menu", "I don't like buses, so go to school _______", 'Walking'),
    new question(5, "The Menu", "How many hours does my class lasts? <br> (Write the number)", '2'),
    new question(6, "The Menu", "What kind of food Do i eat", 'Fast food'),
    new question(7, "The Menu", "What do I play when i'm at home?", 'Videogames'),
    new question(8, "The Menu", "I go to school walking, cause I like to see the streets and the ____", 'Cars'),
    new question(9, "The Menu", "What's my favourite meal?", 'Pizza'),
];